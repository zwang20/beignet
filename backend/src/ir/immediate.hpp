            ...
            Immediate(ImmOpCode op, const Immediate &other, Type dstType) {
                switch (op) {
                    ...
                    case IMM_BITCAST:
                        ...
                        break;
                    case IMM_FPTOUI:
                        *this = Immediate((uint32_t) *other.data.f32);
                        break;
                    case IMM_FPTOSI:
                        *this = Immediate((int32_t) *other.data.f32);
                        break;
                    case IMM_UITOFP:
                        *this = Immediate((float) *other.data.u32);
                        break;
                    case IMM_SITOFP:
                        *this = Immediate((float) *other.data.s32);
                        break;
                    case IMM_HFTOUS:
                        *this = Immediate((uint16_t) *other.data.f16);
                        break;
                    case IMM_HFTOSS:
                        *this = Immediate((int16_t) *other.data.f16);
                        break;
                    case IMM_USTOHF:
                        *this = Immediate(half::convToHalf(*other.data.u16));
                        break;
                    case IMM_SSTOHF:
                        *this = Immediate(half::convToHalf(*other.data.s16));
                        break;
                    case IMM_SEXT: {
                        ...
                        switch (dstType) {
                            ...
                            case TYPE_S8:
                                *this = Immediate((int8_t) value);
                                break;
                            case TYPE_S16:
                                *this = Immediate((int16_t) value);
                                break;
                            case TYPE_S32:
                                *this = Immediate((int32_t) value);
                                break;
                            case TYPE_S64:
                                *this = Immediate((int64_t) value);
                                break;
                        }
                    }
                    case IMM_ZEXT: {
                        ...
                        switch (dstType) {
                            default:
                                GBE_ASSERT(0 && "Illegal sext constant expression");
                            case TYPE_U8:
                                *this = Immediate((uint8_t) value);
                                break;
                            case TYPE_U16:
                                *this = Immediate((uint16_t) value);
                                break;
                            case TYPE_U32:
                                *this = Immediate((uint32_t) value);
                                break;
                            case TYPE_U64:
                                *this = Immediate((uint64_t) value);
                                break;
                        }
                        break;
                    }
